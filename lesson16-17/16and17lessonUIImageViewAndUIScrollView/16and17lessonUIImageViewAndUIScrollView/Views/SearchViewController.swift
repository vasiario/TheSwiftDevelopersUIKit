...
final class SearchViewController: UIViewController, UIScrollViewDelegate {
  ...
  private var searchTopLabel = UILabel()
  private var searchTopField = UITextField()
  private var recentlyViewTextLabel = UILabel()
  private var cleanButton = UIButton()
  private var requesOptionsLabel = UILabel()
  
  /// ScrollView
  private var topScrollView = UIScrollView()
  private let airpodsImage = UIImage(named: "airpodsPro")
  private let iphoneImage = UIImage(named: "iphone14pro")
  private let appleWatchImage = UIImage(named: "appleWatchUltra")
  private let macBookImage = UIImage(named: "macbook")
  private let chargeMacBookImage = UIImage(named: "chargeMacbook")
