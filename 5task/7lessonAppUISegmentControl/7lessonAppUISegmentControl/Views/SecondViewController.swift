...
final class SecondViewController: UIViewController {
    ...
    func addButtonSecondView() {
        ...
        buttonSecondView.setTitle("Adidas", for: .normal)
    ...
    @objc func nextViewButtonPressed(target: UIButton) {
        ...
        if target == buttonSecondView {
            ...
            let secondViewController = storyboard?.instantiateViewController(withIdentifier: "ThirdViewController")
    ...
    func addEmptyButtonOne() {
        ...
        emptyButtonOne.setTitle("Reebok", for: .normal)
    ...
    func addEmptyButtonTwo() {
        ...
        emptyButtonTwo.setTitle("Nike", for: .normal)
